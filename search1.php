...
if($_GET['type'] == 'word') {
	...
	if($sql){
		...
		<table class='sample' border='1'><br>
			...
			<tr>
				<th>Strain</th>
				<th width='300px'>Genotype</th>
				<th>Recipient</th>
				<th>Donor</th>
				<th width='300px'>Comment</th>
				<th>Signature</th>
				<th>Created</th>
				<th>Select<input type='hidden' name='toggle' value='set' />
			...
			<form action='index.php?mode=myList' name='selectRow' method='post'><input type='submit' title='Show a table of only the selected strains' name='show' value='Show selected'/>
