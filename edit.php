...
if($_SESSION['Usertype'] == 'Superuser') {
	...
	echo "<table class='sample' border='1'><br>";
		...
		echo "<tr>";
			...
			echo "<th><span style='color: white'>__</span>Parents<span style='color: white'>__</span></th>";
			echo "<th width='300px'>Comment</th>";
			echo "<th>Signature</th>";
			echo "<th>Created</th>";
		echo "</tr>";

		echo "<form name='strainstoupdate' method='post' action='index.php?mode=edit' ><input type='submit' title='Save the changes' name='save' value='save'/>";
